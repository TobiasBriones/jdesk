...
public final class TaskDialog<R> extends Dialog {
    ...
    public abstract static class TaskDialogCallback<R> extends AppWorkCallback<R> {
        public TaskDialogCallback(engineer.mathsoftware.jdesk.Window window) {
            super(window);
        }
    ...
    public abstract static class TaskDialogCallbackCancelEnabled<R> extends TaskDialogCallback<R> {
        public TaskDialogCallbackCancelEnabled(engineer.mathsoftware.jdesk.Window window) {
            super(window);
        }
    ...
    public abstract static class TaskDialogCallbackCancelDisabled<R> extends TaskDialogCallback<R> {
        public TaskDialogCallbackCancelDisabled(engineer.mathsoftware.jdesk.Window window) {
            super(window);
        }
     ...
     * @param msg    dialog message
     */
    public TaskDialog(engineer.mathsoftware.jdesk.Window window, String title, String msg) {
