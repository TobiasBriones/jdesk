 ...
 */
public class ItemInputPane extends engineer.mathsoftware.jdesk.ui.view.Panel implements Iterable<String> {
    private static final long serialVersionUID = -352531864001279392L;
    private final int columns;
    private final List<ItemView> items;
    private final GridBagConstraints gbc;
    private final ScrollPane scroll;
    private final engineer.mathsoftware.jdesk.ui.view.Panel panelTop;
    private final engineer.mathsoftware.jdesk.ui.view.Panel panelBottom;
    ...
    public ItemInputPane(WindowContext context, int rows, int columns) {
        ...
        this.panelTop = new engineer.mathsoftware.jdesk.ui.view.Panel(context);
        this.panelBottom = new engineer.mathsoftware.jdesk.ui.view.Panel(context);
