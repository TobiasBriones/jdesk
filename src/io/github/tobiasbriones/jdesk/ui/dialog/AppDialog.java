...
import io.github.tobiasbriones.jdesk.resources.AppStringResources;
import io.github.tobiasbriones.jdesk.resources.StringResources;
import io.github.tobiasbriones.jdesk.ui.view.InputText;
import io.github.tobiasbriones.jdesk.ui.view.PasswordInputText;
import io.github.tobiasbriones.jdesk.ui.view.TextLabel;
...
public final class AppDialog {
    ...
    private static String showInput(
        ...
        final OptionButton okButton = new OptionButton(window, okStr);
        final ActionPanel actionPanel = new ActionPanel(window, cancelButton, okButton);
        final io.github.tobiasbriones.jdesk.ui.dialog.Dialog dialog = new Dialog(window);
        final ActionListener l = e -> {
            if (e.getSource() == okButton) {
                final String text;
